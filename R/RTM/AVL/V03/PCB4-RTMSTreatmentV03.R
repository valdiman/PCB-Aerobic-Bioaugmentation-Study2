...
rtm.PCB4 = function(t, state, parms){
  ...
  ko <- 50 # cm/d PCB 4 mass transfer coefficient to SPME
  ...
  bl <- 0.01 # cm boundary layer thickness
  ...
  kb <- 0.1 # 1/d, value changes depending on experiment, i.e., control = 0, treatments LB400 = 0.130728499
...
# Save plot in folder
ggsave("Output/Plots/RTM/PCB4ALV_S_Control.png", plot = p.4, width = 6,
       height = 5, dpi = 500)

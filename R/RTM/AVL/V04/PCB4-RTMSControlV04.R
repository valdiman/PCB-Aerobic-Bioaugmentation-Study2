...
rtm.PCB4 = function(t, state, parms){
  ...
  kb <- 0.02 #23 # 1/d, value changes depending on experiment 0.023 from SPME calibration
...
parms <- list(ka = 0.089, kd = 0.0007) #Input reasonable estimate of ka and kd (placeholder values) kd = 0.000036, 0.0005
...
# Save plot in folder
ggsave("Output/Plots/RTM/PCB4ALV_S_Control.png", plot = p.4, width = 15,
       height = 5, dpi = 500)

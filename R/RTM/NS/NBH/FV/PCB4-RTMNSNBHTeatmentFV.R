...
parms <- list(ro = 500, ko = 6, kb = 0.0, kblb400 = 0.3) # Input
...

{
  ...
  # Export data
  write.csv(model_results_daily_clean, file = "Output/Data/RTM/NS/NBH/PCB4AVLSTreatmentFV.csv")
...
# Save plot in folder
ggsave("Output/Plots/RTM/NS/NBH/PCB4ALV_NS_TreatmentFV.png", plot = p.4, width = 6,
       height = 5, dpi = 500)

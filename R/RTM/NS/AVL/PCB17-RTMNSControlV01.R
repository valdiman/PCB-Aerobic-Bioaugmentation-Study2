...
rtm.PCB17 = function(t, state, parms){
  ...
  Kow <- 10^(5.25) # PCB 17 octanol-water equilibrium partition coefficient @ 25 C
  dUow <- -22888.94 # internal energy for the transfer of octanol-water for PCB 17 (J/mol)
  Koa <- 10^(7.066554861) # PCB 17 octanol-air equilibrium partition coefficient @ 25 C
...
# Save plot in folder
ggsave("Output/Plots/RTM/NS/AVL/PCB17ALV_NS_Control.png", plot = p.17, width = 15,
       height = 5, dpi = 500)

...

{
  ...
  # Export data
  write.csv(model_results_daily_clean, file = "Output/Data/RTM/NS/AVL/PCB19AVLSTreatmentFV.csv")
...
# Save plot in folder
ggsave("Output/Plots/RTM/NS/AVL/PCB19ALV_NS_TreatmentFV.png", plot = p.19, width = 6,
       height = 5, dpi = 500)

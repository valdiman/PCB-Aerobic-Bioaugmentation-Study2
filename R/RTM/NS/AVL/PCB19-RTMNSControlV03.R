...
Ct <- 259.8342356 * 1.3 # ng/g PCB 19 sediment concentration
...
# Export data
write.csv(model_results_daily_clean, file = "Output/Data/RTM/PCB19NSControl.csv")
...
# Save plot in folder
ggsave("Output/Plots/RTM/PCB19ALV_NS_Control.png", plot = p.19, width = 6,
       height = 5, dpi = 500)

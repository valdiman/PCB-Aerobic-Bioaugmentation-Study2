...
rtm.PCB4 = function(t, state, parms){
  ...
  dCwdt <- (kaw.o * Aaw / Vw * (Ca / (Kaw) - Cw) + Cw * kd * (M * Vw) * K / Vw - ka * Cw - kb * Cw) / B # 864 to change second to days and um to m, Ca in [ng/L]
...
# Estimating Cw (PCB 4 concentration in Cw from equilibrium with the sediment)
...
parms <- list(kb = 0.02, ka = 10, kd = 0.000687) # Input 

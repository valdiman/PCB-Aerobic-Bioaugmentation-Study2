...
rtm.PCB4 = function(t, state, parms){
  ...
  ko <- 0.5 # cm/d PCB 4 mass transfer coefficient to SPME
...
Ct <- 314.263 * 1.5 # ng/g PCB 4 sediment concentration wet!
...
# Export data
# write.csv(model_results_daily_clean, file = "Output/Data/RTM/PCB4NBHNSControl.csv")
...
# Save plot in folder
ggsave("Output/Plots/RTM/PCB4NBH_NS_Control.png", plot = p.4, width = 15,
       height = 5, dpi = 500)
